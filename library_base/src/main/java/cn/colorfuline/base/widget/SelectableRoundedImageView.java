...
public class SelectableRoundedImageView extends AutoChangeColorImageView {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int cornerRadius = a.getDimensionPixelSize(
                R.styleable.SelectableRoundedImageView_sriv_corner_radius, 0);
        if (cornerRadius > 0) {
            mLeftTopCornerRadius = mRightTopCornerRadius = mLeftBottomCornerRadius = mRightBottomCornerRadius = cornerRadius;
        } else {
