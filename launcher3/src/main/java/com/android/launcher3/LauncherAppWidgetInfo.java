...
public class LauncherAppWidgetInfo extends ItemInfo {
     ...
     *
     */
    public static final int FLAG_RECOMMEND_WIDGET = 9;
    ...
    int tempAppWidgetId = NO_ID;

    ComponentName tempProviderName;

    int tempAppwidgetLayoutId;

    boolean isUseTemp = false;
    ...
    public int getAppWidgetId() {
        return isUseTemp ? tempAppWidgetId : appWidgetId;
    }
    ...
    public ComponentName getProviderName() {
        return isUseTemp ? tempProviderName : providerName;
    }

    public void setProviderName(ComponentName providerName) {
        this.providerName = providerName;
    }

    public int getTempAppWidgetId() {
        return tempAppWidgetId;
    }

    public void setTempAppWidgetId(int tempAppWidgetId) {
        this.tempAppWidgetId = tempAppWidgetId;
    }

    public ComponentName getTempProviderName() {
        return tempProviderName;
    }

    public void setTempProviderName(ComponentName tempProviderName) {
        this.tempProviderName = tempProviderName;
    }
    ...
    LauncherAppWidgetInfo(int appWidgetId, ComponentName providerName,int itemType) {
