...
public class PendingAppWidgetHostView extends LauncherAppWidgetHostView implements OnClickListener {
    ...
    public PendingAppWidgetHostView(Context context, LauncherAppWidgetInfo info,
        ...
        mIconLookupIntent = new Intent().setComponent(info.getProviderName());
    ...
    public void updateIcon(int layoutid) {
        mDefaultView = LayoutInflater.from(getContext()).inflate(layoutid, null);
        mDefaultView.setOnClickListener(this);
    }
