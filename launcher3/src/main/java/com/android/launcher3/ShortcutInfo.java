...
public class ShortcutInfo extends ItemInfo {
     ...
     *
     */
    public static final int FLAG_RECOMMEND_ICON = 9;
    ...
    public ComponentName getTargetComponent() {
        return promisedIntent != null ? promisedIntent.getComponent() : intent!=null?intent.getComponent():null;
    }
    ...
    public final boolean isPromise() {
        return hasStatusFlag(FLAG_RESTORED_ICON | FLAG_AUTOINTALL_ICON | FLAG_RECOMMEND_ICON);
    }
