...
public class PageIndicator extends LinearLayout {
    ...
    public static class PageMarkerResources {
        ...
        public PageMarkerResources() {
            activeId = R.drawable.shape_pageindicator_current;
            inactiveId = R.drawable.shape_pageindicator_default;
        }
    ...
    public PageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        //设置indicator和hotseat之间的距离
        setPadding(0,0,0,getResources().getDimensionPixelOffset(R.dimen.dynamic_grid_page_indicator_padding_bottom));
    }
    ...
    void offsetWindowCenterTo(int activeIndex, boolean allowAnimations) {
        ...
        for (int i = 0; i < mMarkers.size(); ++i) {
            ...
            if(i!=0){
                ((LinearLayout.LayoutParams)marker.getLayoutParams())
                        .setMargins(getResources().getDimensionPixelSize(R.dimen.dp_8),0,0,0);
            }
