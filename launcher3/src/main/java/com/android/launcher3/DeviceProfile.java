...
public class DeviceProfile {
    ...
    public static final String SPKEY_FONTSCALE = "fontScale";
    public static final float DEFAULT_FONTSCALE = 1.0f;
    private float fontScale = 1.0f;

    public void setFontScale(float fontScale) {
        this.fontScale = fontScale;
        DisplayMetrics dm = context.getResources().getDisplayMetrics();
        allAppsIconTextSizePx = (int) (Utilities.pxFromDp(inv.iconTextSize, dm) * fontScale);
        iconTextSizePx = (int) (Utilities.pxFromSp(inv.iconTextSize, dm) * fontScale);
    }
    ...
    public DeviceProfile(Context context, InvariantDeviceProfile inv,
        ...
        fontScale = SPUtil.getFloat(context.getApplicationContext(), SPKEY_FONTSCALE, DEFAULT_FONTSCALE);
        this.inv = inv;
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources res,
        ...
        iconTextSizePx = (int) (Utilities.pxFromSp(inv.iconTextSize, dm) * scale * fontScale);
    ...
    public void updateAppsViewNumCols(Resources res, int recyclerViewWidth) {
        ...
        allAppsNumCols = inv.minAllAppsPredictionColumns;
...
//                        hotseatBarHeightPx, edgeMarginPx);
            ...
            if (isTablet) {
                ...
                int paddingTop = 0; //searchBarBounds.bottom;
                ...
                // Pad the top and bottom of the workspace with search/hotseat bar sizes  去掉搜索框占位  searchBarBounds.bottom
