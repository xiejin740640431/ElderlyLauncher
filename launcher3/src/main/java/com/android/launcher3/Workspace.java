...
public class Workspace extends PagedView
    ...
    public void createCustomContentContainer() {
        ...
        customScreen.setCanvasLine(false);
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            switch (info.itemType) {
                ...
                case Favorites.ITEM_TYPE_RECOM_APPLICATION:
        ...
        return (LauncherAppWidgetHostView) getFirstMatch(new ItemOperator() {
            ...
            public boolean evaluate(ItemInfo info, View v, View parent) {
                return (info instanceof LauncherAppWidgetInfo) &&
                        ((LauncherAppWidgetInfo) info).getAppWidgetId() == appWidgetId;
            }
        });
    }
    ...
    void widgetsRestored(ArrayList<LauncherAppWidgetInfo> changedInfo) {
        if (!changedInfo.isEmpty()) {
            ...
            if (LauncherModel.getProviderInfo(getContext(),
                    changedInfo.get(0).getProviderName(),
        ...
        public void run() {
            ...
            for (LauncherAppWidgetInfo info : mInfos) {
                if (info.hostView instanceof PendingAppWidgetHostView) {
                    ...
                    cl.removeView(view);
                    mLauncher.bindAppWidget(info);
                } else if (info.hostView instanceof AppWidgetHostView) {
                    AppWidgetHostView view = info.hostView;
                    mLauncher.removeAppWidget(info);
