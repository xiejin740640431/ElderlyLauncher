...
public class LauncherSettings {
    ...
    static interface BaseLauncherColumns extends ChangeLogColumns {
         ...
         * 推荐应用（未安装）
         */
        public static final int ITEM_TYPE_RECOM_APPLICATION = 6;
        /**
         * 位置固定
         */
        public static final int ITEM_TYPE_FIXED_APPLICATION = 7;
    ...
    public static final class Favorites implements BaseLauncherColumns {
         ...
         * 推荐应用的小部件
         */
        public static final int ITEM_TYPE_RECOMMEND_APPWIDGET = 8;
         ...
         * 资源图片名称
         */
        public static final String ICON_RESOURCE_NAME = "iconResourceName";
        /**
         * 下载地址
         */
         ...
         * 是否支持删除
         */
        public static final String SUPPORT_DELETE = "supportDelete";
        /**
         * 支持删除
         */
        public static final int ITEM_SUPPORT_DELETE = 0;
        /**
         * 发送清除信息广播（联系人appWidget）
         */
        public static final int ITEM_SUPPORT_CLEAR = 1;
        /**
         * 不能删除
         */
        public static final int ITEM_NOT_SUPPORT_DELETE = 2;
    }
